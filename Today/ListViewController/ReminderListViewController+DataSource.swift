...
extension ReminderListViewController {
    ...
    func cellRegistrationHandler(
        ...
        cell.accessibilityValue = reminder.isComplete ? reminderNotCompletedValue : reminderNotCompletedValue
        cell.accessories = [
    ...
    private func doneButtonAccessibilityAction(for reminder: Reminder) -> UIAccessibilityCustomAction
        {
            let name = NSLocalizedString("Toggle Completion", comment: "Reminder done button accesibilty label")
